...
namespace humanoid_robot
{
    namespace server
    {
        namespace modules
        {
            ...
            private:
                // 获取机器人当前位姿
                ModuleResult GetCurrentPose(const humanoid_robot::PB::common::Dictionary &input_data,
                                            const humanoid_robot::PB::common::Dictionary &params);

                // 获取2D栅格地图
                ModuleResult GetGridMap2D(const humanoid_robot::PB::common::Dictionary &input_data,
                                          const humanoid_robot::PB::common::Dictionary &params);

                // 开始导航
                ModuleResult NavigationTo(const humanoid_robot::PB::common::Dictionary &input_data,
                                             const humanoid_robot::PB::common::Dictionary &params);

                // 取消当前导航任务
                ModuleResult CancelNavigationTask(const humanoid_robot::PB::common::Dictionary &input_data,
                                                  const humanoid_robot::PB::common::Dictionary &params);

                // 获取剩余路径距离
                ModuleResult GetRemainingPathDistance(const humanoid_robot::PB::common::Dictionary &input_data,
                                                      const humanoid_robot::PB::common::Dictionary &params);

                // 开始充电
                ModuleResult StartCharging(const humanoid_robot::PB::common::Dictionary &input_data,
                                           const humanoid_robot::PB::common::Dictionary &params);

                // 结束充电
                ModuleResult StopCharging(const humanoid_robot::PB::common::Dictionary &input_data,
                                          const humanoid_robot::PB::common::Dictionary &params);
