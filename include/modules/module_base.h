...
#ifndef HUMANOID_ROBOT_MODULE_BASE_H
#define HUMANOID_ROBOT_MODULE_BASE_H
    ...
    namespace server
    {
        namespace modules
        {
            ...
            struct ModuleResult
            {
                ...
                static ModuleResult Success(const std::string &module, const int32_t &cmd,
            ...
            public:
                 ...
                 * @return 结果的future
                 */
                std::future<ModuleResult> ExecuteAsync(
                 ...
                 * 获取模块状态信息
                 */
                virtual std::unique_ptr<humanoid_robot::PB::common::Dictionary> GetStatus() const;
            ...
            protected:
                 ...
                 * @return 执行结果
                 */
                virtual ModuleResult ProcessCommand(
                    grpc::ServerContext *context, const int32_t &command_id,
